...
@OnlyIn(Dist.CLIENT)
public class CrimsonGoatShearedModel <T extends CrimsonGoatShearedEntity> extends QuadrupedModel<T> {
    public CrimsonGoatShearedModel(ModelPart p_170578_) {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition partdefinition1 = partdefinition.addOrReplaceChild("head", CubeListBuilder.create().texOffs(2, 61).addBox("right ear", -6.0F, -11.0F, -10.0F, 3.0F, 2.0F, 1.0F).texOffs(2, 61).mirror().addBox("left ear", 2.0F, -11.0F, -10.0F, 3.0F, 2.0F, 1.0F).texOffs(23, 52), PartPose.offset(1.0F, 14.0F, 0.0F));
        ...
        partdefinition.addOrReplaceChild("body", CubeListBuilder.create().texOffs(1, 1).addBox(-4.0F, -17.0F, -7.0F, 9.0F, 11.0F, 16.0F).texOffs(0, 28), PartPose.offset(0.0F, 24.0F, 0.0F));
